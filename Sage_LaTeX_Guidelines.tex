...
\title{Developing a meta-model for early-stage overheating risk assessment for new apartments in London}

\author{Andrea Botti\affilnum{1} and Lucky Person\affilnum{2}}

\affiliation{\affilnum{1}University of Surrey, UK\\
\affilnum{2}SAGE Publications Ltd, UK}

\corrauth{Andrea Botti, Centre for Environment and Sustainability,\\
University of Surrey, Guildford, Surrey, GU2~7XH, UK}


\email{a.botti@surrey.ac.uk}
